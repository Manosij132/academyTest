CREATE VIEW [dbo].[vwProficiencyDataReport]
AS
...
SELECT	e.BetterMeLeaderEmail, e.GlobantEmailAddress, ISNULL(tc.TrainingsAssigned, 0) AS TrainingsAssigned, 
		...
		csk.Skills AS ConsolidatedSkills, e.EmployeeName, e.Tdc AS TDC, tc.TrainingAssignedDate, 
